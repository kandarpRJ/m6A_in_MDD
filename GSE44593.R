...
gse.pheno<-pData(gse)
gse.pheno<-data.frame(gse.pheno[gse.pheno$`disease status:ch1`=="Control" | gse.pheno$`disease status:ch1`=="MDD",c("geo_accession", "characteristics_ch1.3", "characteristics_ch1")])
colnames(gse.pheno)<-c("geo_accession", "label", "tissue")
gse.pheno$tissue<-gsub("tissue: human_brain_AMY", "AMY", gse.pheno$tissue)
gse.pheno$label<-gsub("disease status: Control", "control", gse.pheno$label)
gse.pheno$label<-gsub("disease status: MDD", "depression", gse.pheno$label)
